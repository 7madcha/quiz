...
urlpatterns = [
    ...
    path('teacher/<int:quiz_id>/results/', views.teacher_quiz_results, name='teacher_quiz_results'),
    path('teacher/<int:quiz_id>/publish/', views.teacher_publish_quiz, name='teacher_publish_quiz'),
    path('teacher/<int:quiz_id>/unpublish/', views.teacher_unpublish_quiz, name='teacher_unpublish_quiz'),
    ...
    path('teacher/choice/<int:choice_id>/edit/', views.teacher_edit_choice, name='teacher_edit_choice'),
    path('teacher/choice/<int:choice_id>/delete/', views.teacher_delete_choice, name='teacher_delete_choice'),
